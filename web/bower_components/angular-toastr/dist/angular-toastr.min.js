!function () {
    ...
    function t(t, e, s, n, o, r, a) {
        function i(t) {
            if (t)m(t.toastId); else for (var e = 0; e < O.length; e++)m(O[e].toastId)
        }

        function l(t, e, s) {
            var n = g().iconClasses.error;
            return d(n, t, e, s)
        }

        function c(t, e, s) {
            var n = g().iconClasses.info;
            return d(n, t, e, s)
        }

        function u(t, e, s) {
            var n = g().iconClasses.success;
            return d(n, t, e, s)
        }

        function p(t, e, s) {
            var n = g().iconClasses.warning;
            return d(n, t, e, s)
        }
        ...
        function m(e, s) {
            ...
            i && !i.deleting && (i.deleting = !0, i.isOpened = !1, t.leave(i.el).then(function () {
                ...
                var t = O.indexOf(i);
                delete w[i.scope.message], O.splice(t, 1);
                var e = r.maxOpened;
        ...
        function v(s) {
            ...
            function u() {
                var t = p.preventDuplicates && s.message === B, e = p.preventOpenDuplicates && w[s.message];
            ...
            if (!u()) {
                var d = i();
                if (O.push(d), p.autoDismiss && p.maxOpened > 0)for (var v = O.slice(0, O.length - p.maxOpened), T = 0, $ = v.length; $ > T; T++)m(v[T].toastId);
                return c() && d.open.resolve(), d.open.promise.then(function () {
                    f(p).then(function () {
                        if (d.isOpened = !0, p.newestOnTop)t.enter(d.el, C).then(function () {
                            d.scope.init()
                        }); else {
                            var e = C[0].lastChild ? angular.element(C[0].lastChild) : null;
                            t.enter(d.el, C, e).then(function () {
                                d.scope.init()
                            })
                        }
                    })
    ...
    function t(t, e, s, n) {
        function o(s, o, r, a) {
            ...
            if (s.toastClass = s.options.toastClass, s.titleClass = s.options.titleClass, s.messageClass = s.options.messageClass, s.progressBar = s.options.progressBar, c()) {
                var p = angular.element(s.options.closeHtml), m = t.get("$compile");
                p.addClass("toast-close-button"), p.attr("ng-click", "close()"), m(p)(s), o.prepend(p)
            }
            s.init = function () {
